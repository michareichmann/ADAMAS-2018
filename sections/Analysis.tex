...
\begin{frame}{Waveforms}
	...
	\vspace*{-20pt}
	\fig[r]{.3}{WFN}\vspace*{-20pt}
	\fig[r]{.3}{PP}[Peak timings.]\vspace*{-10pt}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%% FRAME 3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Track Slope}
\begin{frame}{Track Slope}
	
	\subfigs{\subfig{.5}[r]{TAX}[Track angle in X]}{\subfig{.5}[r]{TAY}[Track angle in Y]}
